...
public class CrocodocExamples {
    public static String apiToken = "SuXIxvypN7JgrqMOAnU0EKec";
    ...
    public static String example3() {
        ...
        try {
        	File file = new File( Thread.currentThread().getContextClassLoader().getResource("example-files/form-w4.pdf" ).toURI() );
